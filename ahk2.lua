...
def_commands ({
  ...
  ControlChoose = 'SSSSSS',
  ControlChooseString = 'SSSSSS',
  ControlClick = 'SSSSSSSS',
  ControlDeleteItem = 'SSSSSS',
  ControlEditPaste = 'SSSSSS',
  ControlFindItem = 'OSSSSSS',
  ControlFocus = 'SSSSS',
  ControlGetChecked = 'OSSSSS',
  ControlGetChoice = 'OSSSSS',
  ControlGetCurrentCol = 'OSSSSS',
  ControlGetCurrentLine = 'OSSSSS',
  ControlGetEnabled = 'OSSSSS',
  ControlGetExStyle = 'OSSSSS',
  ControlGetFocus = 'OSSSS',
  ControlGetHwnd = 'OSSSSS',
  ControlGetLine = 'OSSSSSS',
  ControlGetLineCount = 'OSSSSS',
  ControlGetList = 'OSSSSSS',
  ControlGetPos = 'OOOOSSSSS',
  ControlGetSelected = 'OSSSSS',
  ControlGetStyle = 'OSSSSS',
  ControlGetTab = 'OSSSSS',
  ControlGetText = 'OSSSSS',
  ControlGetVisible = 'OSSSSS',
  ControlHide = 'SSSSS',
  ...
  DriveEject = 'SS',
  DriveGetCapacity = 'OS',
  DriveGetFilesystem = 'OS',
  DriveGetLabel = 'OS',
  DriveGetList = 'OS',
  DriveGetSerial = 'OS',
  DriveGetSpaceFree = 'OS',
  DriveGetStatus = 'OS',
  DriveGetStatusCD = 'OS',
  DriveGetType = 'OS',
  DriveLock = 'S',
...
local Loop_args =
  (token(l.KEYWORD, keyword'Parse')
    * ws * comma * args(arg_normal, arg_normal, arg_normal)) +
